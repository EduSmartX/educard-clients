...
export type RelationshipValue = (typeof RELATIONSHIP)[keyof typeof RELATIONSHIP];
...
export type MaritalStatusValue = (typeof MARITAL_STATUS)[keyof typeof MARITAL_STATUS];
