 ...
 */
export function getRoleGradient(userRole?: string): readonly [string, string, string] {
  const theme = getRoleThemeColors(userRole);
  return [theme.gradientStart, theme.gradientMiddle, theme.gradientEnd] as const;
}
