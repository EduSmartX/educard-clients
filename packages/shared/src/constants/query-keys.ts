...
export const QueryKeys = {
  ...
  STUDENTS: {
    ...
    INFINITE: (params?: Record<string, unknown>) => ['students', 'infinite', params] as const,
  ...
  TEACHERS: {
    ...
    INFINITE: (params?: Record<string, unknown>) => ['teachers', 'infinite', params] as const,
  ...
  CLASSES: {
    ...
    INFINITE: (params?: Record<string, unknown>) => ['classes', 'infinite', params] as const,
  ...
  SUBJECTS: {
    ...
    INFINITE: (params?: Record<string, unknown>) => ['subjects', 'infinite', params] as const,
  ...
  ATTENDANCE: {
    ...
    BY_DATE: (date: string, classId?: string) => ['attendance', 'date', date, classId] as const,
    ...
    STAFF: {
      ...
      LIST: (params?: Record<string, unknown>) => ['attendance', 'staff', 'list', params] as const,
    },
    TIMESHEET: {
      LIST: (params?: Record<string, unknown>) => ['attendance', 'timesheet', 'list', params] as const,
      DETAIL: (id: string) => ['attendance', 'timesheet', 'detail', id] as const,
    },
  },
  ...
  HOLIDAYS: {
    ...
    LIST: (params?: Record<string, unknown>) => ['holidays', 'list', params] as const,
    DETAIL: (id: string) => ['holidays', 'detail', id] as const,
    CALENDAR: (year?: number, month?: number) => ['holidays', 'calendar', year, month] as const,
  },
  ...
  LEAVE: {
    ALLOCATIONS: {
      ...
      LIST: (params?: Record<string, unknown>) => ['leave', 'allocations', 'list', params] as const,
      DETAIL: (id: string) => ['leave', 'allocations', 'detail', id] as const,
      FOR_USER: (userId: string) => ['leave', 'allocations', 'user', userId] as const,
    },
    BALANCES: {
      ALL: ['leave', 'balances'] as const,
      LIST: (params?: Record<string, unknown>) => ['leave', 'balances', 'list', params] as const,
      SUMMARY: ['leave', 'balances', 'summary'] as const,
      MY_BALANCE: ['leave', 'balances', 'my'] as const,
      USER_BALANCE: (userId: string) => ['leave', 'balances', 'user', userId] as const,
    },
    REQUESTS: {
    ...
    REVIEWS: {
      ...
      LIST: (params?: Record<string, unknown>) => ['leave', 'reviews', 'list', params] as const,
      PENDING: ['leave', 'reviews', 'pending'] as const,
    },
    TYPES: {
      ALL: ['leave', 'types'] as const,
      LIST: (params?: Record<string, unknown>) => ['leave', 'types', 'list', params] as const,
    },
  },
  ...
  EXAMS: {
    SESSIONS: {
      ...
      LIST: (params?: Record<string, unknown>) => ['exams', 'sessions', 'list', params] as const,
    ...
    MARKS: {
      LIST: (params?: Record<string, unknown>) => ['exams', 'marks', 'list', params] as const,
      BY_EXAM: (examId: string) => ['exams', 'marks', 'exam', examId] as const,
      BY_STUDENT: (studentId: string) => ['exams', 'marks', 'student', studentId] as const,
    },
  },
  ...
  TIMETABLE: {
    GROUPS: {
      ...
      LIST: (params?: Record<string, unknown>) => ['timetable', 'groups', 'list', params] as const,
      DETAIL: (id: string) => ['timetable', 'groups', 'detail', id] as const,
    },
    SLOTS: {
      ALL: ['timetable', 'slots'] as const,
      LIST: (params?: Record<string, unknown>) => ['timetable', 'slots', 'list', params] as const,
      BY_GROUP: (groupId: string) => ['timetable', 'slots', 'group', groupId] as const,
    },
    ENTRIES: {
      ALL: ['timetable', 'entries'] as const,
      LIST: (params?: Record<string, unknown>) => ['timetable', 'entries', 'list', params] as const,
      BY_CLASS: (classId: string) => ['timetable', 'entries', 'class', classId] as const,
      BY_TEACHER: (teacherId: string) => ['timetable', 'entries', 'teacher', teacherId] as const,
    },
  },
  ...
  ATTACHMENTS: {
    ...
    USER_PHOTO: (userId: string) => ['attachments', 'photo', 'user', userId] as const,
