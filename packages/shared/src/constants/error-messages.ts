...
export const InfoMessages = {
  CLASS_TEACHER: {
    BULK_UPLOAD_STUDENTS: 'As a class teacher, students will be uploaded to your assigned class only.',
    BULK_UPLOAD_SUBJECTS: 'As a class teacher, subjects will be uploaded to your assigned class only.',
  },
  ADMIN: {
