 ...
 * After successful password change, user is logged out (RootNavigator returns to login)
 */
...
export default function ChangePasswordScreen() {
  ...
  const handleChangePassword = useCallback(async () => {
    ...
    try {
      ...
      // Show success message and logout (RootNavigator returns to the login stack)
      Alert.alert(
        'Password Changed',
  ...
  }, [oldPassword, newPassword, confirmPassword, logout]);
    ...
    <View style={styles.inputWrapper}>
      ...
      >
        <Lock
          size={20}
          color={
            focusedInput === inputKey ? Colors.primary[500] : Colors.gray[400]
          }
        />
        <TextInput
          style={styles.input}
