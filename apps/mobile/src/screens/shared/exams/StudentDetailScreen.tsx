...
export default function StudentDetailScreen() {
  ...
  const route =
    useRoute<RouteProp<SharedStackParamList, 'ExamStudentDetail'>>();
  const { studentId, sessionId, classId, studentName } = route.params;
  ...
  const student = data?.students.find(st => st.student_public_id === studentId);
  ...
  const pctColor = isPass ? '#16a34a' : '#dc2626';
      ...
      >
          ...
          {!!summary && (
            <>
              ...
              <View style={s.infoRow}>
                ...
                <Text
                  style={[s.infoValue, s.infoValueBold, { color: pctColor }]}
                >
              ...
              <View style={s.infoRow}>
                ...
                <View style={[s.statusBadge, { backgroundColor: statusBg }]}>
                  <Text style={[s.statusText, { color: pctColor }]}>
                    {isPass ? 'PASS' : 'FAIL'}
                  </Text>
                </View>
              </View>
        ...
        <Animated.View entering={FadeInDown.delay(200).springify()}>
          ...
          {subjects.map((sub, idx) => {
            ...
            const markBg = mark?.is_pass ? '#dcfce7' : '#fee2e2';
            const markColor = mark?.is_pass ? '#16a34a' : '#dc2626';
            return (
              <Animated.View
              ...
              >
                ...
                {mark && !mark.is_absent && (
                  <View style={s.marksRow}>
                    ...
                    />
                    <View style={[s.markBadge, { backgroundColor: markBg }]}>
                      <Text style={[s.markBadgeText, { color: markColor }]}>
                        {mark.is_pass ? 'P' : 'F'}
                      </Text>
                    </View>
                  </View>
        ...
        {!!summary && (
          ...
          >
            ...
            <MarksBar
              ...
              pass={Math.round(summary.total_max * 0.35)}
            />
          </Animated.View>
        )}
      </ScrollView>
