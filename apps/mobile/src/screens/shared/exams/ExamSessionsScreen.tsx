...
const SESSION_TYPE_COLORS: Record<
  string,
...
export default function ExamSessionsScreen() {
  ...
  const renderSession = useCallback(
    ({ item, index }: { item: ExamSession; index: number }) => {
      const typeColor =
        SESSION_TYPE_COLORS[item.session_type] || SESSION_TYPE_COLORS.custom;
      ...
      return (
        ...
        >
          <TouchableOpacity
            ...
            activeOpacity={0.7}
            onPress={() =>
              navigation.navigate('ExamDashboard', {
            ...
            <View style={styles.cardHeader}>
              ...
              >
                <Text style={[styles.typeText, { color: typeColor.text }]}>
                  {EXAM_SESSION_TYPE_LABELS[item.session_type] ||
                    item.session_type}
                </Text>
              </View>
