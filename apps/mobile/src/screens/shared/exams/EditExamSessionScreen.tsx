...
export default function EditExamSessionScreen() {
  ...
  const route = useRoute<RouteProp<SharedStackParamList, 'ExamEditSession'>>();
  ...
  const updateSession = useUpdateExamSession({ onSuccess: handleBack });
  ...
  if (loadingSession) {
    return (
      <View style={[layoutStyles.container, st.center]}>
    ...
    <View style={layoutStyles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={[
            st.submitBtn,
            updateSession.isPending && st.submitBtnDisabled,
          ]}
