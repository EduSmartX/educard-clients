...
export default function ChangePhoneScreen() {
  ...
  const route = useRoute<RouteProp<SharedStackParamList, 'ChangePhone'>>();
  ...
  const config: ChangeCredentialConfig = useMemo(
    () => ({
      ...
      sendOtp: value =>
        authApi.sendOtp({ purpose: 'PHONE_VERIFICATION', phone: value }),
      ...
      updateStore: (u, value, result) => ({
        ...
        is_mobile_verified:
          (result as { is_mobile_verified?: boolean }).is_mobile_verified ??
          true,
      }),
