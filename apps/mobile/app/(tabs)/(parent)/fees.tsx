              ...
              <>
                ...
                <View className="mt-4 rounded-xl bg-white p-4">
                  <View className="flex-row items-center justify-between">
                    <Text className="text-xs text-gray-500">Payment Progress</Text>
                    <Text className="text-xs font-medium text-emerald-600">{paidPct}%</Text>
                  </View>
                  ...
                  {summary.is_overdue && (
                    <View className="mt-2 self-start rounded-md bg-red-100 px-2 py-0.5">
                      <Text className="text-[10px] font-medium text-red-600">Overdue</Text>
                    </View>
                  )}
                </View>
              </>
            ...
            {payments && payments.length > 0 ? (
              payments.map((p: FeePayment) => (
                ...
                >
                  ...
                  {p.receipt_number && (
                    <Text className="text-[10px] text-gray-400">#{p.receipt_number}</Text>
                  )}
                </View>
              ))
            ) : (
