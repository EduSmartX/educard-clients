 ...
 * Shares the same screens as admin but with role-based permissions
 * Teachers: View-only access
...
// Routes point to shared admin screens which have role-based permission checks
