 ...
 */
/* eslint-disable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-explicit-any, @typescript-eslint/no-floating-promises */

import { Colors, getRoleGradient, extractApiError } from '@educard/shared';
import { LinearGradient } from 'expo-linear-gradient';
import { useRouter } from 'expo-router';
import { ChevronLeft, Calendar, Plus, List, Grid3x3, Upload } from 'lucide-react-native';
  ...
  return (
    <View style={layoutStyles.container}>
      ...
      <HolidayFormModal
        ...
        onChangeField={(field, value) => setFormData((p) => ({ ...p, [field]: value }))}
      />
