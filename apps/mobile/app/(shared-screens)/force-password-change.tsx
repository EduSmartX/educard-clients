...
import { Lock, Eye, EyeOff, KeyRound, CheckCircle, ShieldAlert } from 'lucide-react-native';
...
export default function ForcePasswordChangeScreen() {
  ...
  const handleChangePassword = useCallback(async () => {
    ...
    if (oldPassword === newPassword) {
      Alert.alert('Error', 'New password must be different from the default password');
      return;
    }
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(100).duration(600)} style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>
            You're signed in with a default password. Please set a new one to continue.
          </Text>
        </Animated.View>
        ...
        <Animated.View entering={FadeInUp.delay(200).duration(600)} style={styles.formCard}>
          <View style={styles.noticeBox}>
            <ShieldAlert size={16} color={Colors.warning[600]} />
            <Text style={styles.noticeText}>This step is required before you can continue.</Text>
          </View>
          ...
          {renderPasswordInput(
            ...
            setShowOldPassword,
            'old',
            'Enter current default password'
          )}
