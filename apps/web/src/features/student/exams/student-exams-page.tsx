            ...
            <CardContent className="p-4">
              {upcomingSessions.length > 0 ? (
                ...
                <div className="flex items-center gap-3 py-6 text-center">
                  ...
                  <p className="text-sm text-gray-500">No upcoming exams — relax and prepare!</p>
                </div>
              )}
            </CardContent>
          </Card>
                ...
                <Card className="overflow-hidden bg-gradient-to-r from-violet-500 to-purple-600 text-white">
                  <CardContent className="p-6">
                    ...
                    {(() => {
                      ...
                      const totalObtained = appeared.reduce(
                        (s, e) => s + (e.marks_obtained ?? 0),
                        0
                      );
...
function SubjectResultRow({ exam }: { exam: ExamResult }) {
  const theme = getSubjectTheme(exam.subject_name);
  const SubjectIcon = theme.icon;
