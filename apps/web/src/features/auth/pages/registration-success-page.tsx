            ...
            <div className="space-y-6 p-8">
              ...
              <div className="text-center">
                <p className="text-lg text-gray-700">
                  ...
                  <strong className="text-teal-600">"{registrationData.organizationName}"</strong>{' '}
                  has been successfully registered with {BRANDING.APP_NAME}.
                </p>
              </div>
              ...
              <div className="rounded-lg border-2 border-cyan-200 bg-gradient-to-br from-cyan-50 to-blue-50 p-6">
                ...
                <p className="mb-4 text-gray-700">
                  Your organization registration has been received successfully. Our team will
                  review your application and verify the details.
                </p>
                <div className="mb-4 rounded-lg bg-white p-4">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-3 text-gray-700">
                      ...
                      <span>
                        <strong>Configure leave allocations</strong> - Set up leave policies for
                        staff and teachers
                      </span>
                    </li>
                  </ul>
                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                  <p className="text-sm text-amber-800">
                    ...
                    takes 24-48 hours. You will receive a confirmation email once your organization
                    is approved.
                  </p>
                </div>
              </div>
