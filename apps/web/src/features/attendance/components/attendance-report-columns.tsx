...
export function createYearlyReportColumns(): Column<YearlyReportRow>[] {
  return [
    {
      header: 'Month',
      accessor: (row) => <div className="font-semibold text-gray-900">{row.month}</div>,
      sortable: true,
      sortKey: 'month',
    },
    {
      header: 'Working Days',
      accessor: (row) => (
        <div className="text-center font-medium text-gray-700">{row.totalWorkingDays}</div>
      ),
      sortable: true,
    ...
    },
    {
      header: 'Present',
      accessor: (row) => (
        <Badge className="bg-green-600 font-semibold hover:bg-green-700">{row.present}</Badge>
      ),
      sortable: true,
      sortKey: 'present',
    },
    {
      header: 'Absent',
      accessor: (row) => (
        <Badge className="bg-red-600 font-semibold hover:bg-red-700">{row.absent}</Badge>
      ),
      sortable: true,
      sortKey: 'absent',
    },
    {
      header: 'Leaves',
      accessor: (row) => (
        <Badge className="bg-blue-600 font-semibold hover:bg-blue-700">{row.leaves}</Badge>
      ),
      sortable: true,
      sortKey: 'leaves',
    },
    {
      header: 'Holidays',
      accessor: (row) => (
        <Badge className="bg-purple-600 font-semibold hover:bg-purple-700">{row.holidays}</Badge>
      ),
      sortable: true,
      sortKey: 'holidays',
    },
...
export function createMonthlyReportColumns(): Column<MonthlyReportRow>[] {
  return [
    {
      header: 'Date',
      accessor: (row) => <div className="font-medium text-gray-900">{row.date}</div>,
      sortable: true,
      sortKey: 'date',
    },
    {
      header: 'Day',
      accessor: (row) => <div className="text-gray-700">{row.day}</div>,
      sortable: false,
    },
    {
      header: 'Status',
...
export function exportMonthlyReportToCSV(
  ...
  const rows = data.map((row) => [row.date, row.day, getStatusLabel(row.status)]);
