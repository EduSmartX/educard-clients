...
export const roleThemes: Record<RoleTheme, ThemeConfig> = {
  ...
  student: {
    // Pink/Rose theme for Student
    headerBg: 'bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600',
    headerShadow: 'shadow-xl shadow-pink-500/20',
    subtitleText: 'text-pink-100',
    notificationRing: 'ring-pink-600',
    avatarGradient: 'from-pink-500 to-rose-600',
    sidebarActiveBg: 'bg-gradient-to-r from-pink-500 to-rose-500',
    sidebarActiveText: 'text-white',
    sidebarActiveShadow: 'shadow-md shadow-pink-500/25',
    mobileMenuBg: 'bg-gradient-to-r from-pink-500 to-rose-500',
    mobileMenuHover: 'hover:from-pink-600 hover:to-rose-600',
    mobileMenuShadow: 'shadow-lg shadow-pink-500/25',
    mainBgGradient: 'bg-gradient-to-br from-slate-50 via-white to-pink-50/30',
