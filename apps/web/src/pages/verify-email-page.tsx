          ...
          <Card className="w-full max-w-lg border-0 shadow-2xl">
            ...
            <CardContent className="space-y-4 px-8 pb-8">
              {isExpired && (
                <Alert className="border-amber-300 bg-gradient-to-r from-amber-50 to-yellow-50 shadow-sm">
                  <AlertDescription className="text-sm text-amber-900">
                    <p className="mb-2 text-base font-semibold">🔗 Link Expired?</p>
              ...
              <Button
                ...
                className="h-12 w-full bg-gradient-to-r from-cyan-500 to-teal-500 text-base font-semibold text-white shadow-lg hover:from-cyan-600 hover:to-teal-600"
              >
                Go to Login
              </Button>
            </CardContent>
        ...
        >
          <Card className="w-full max-w-lg border-0 shadow-2xl">
            <CardHeader className="pb-4 text-center">
              ...
              <CardTitle className="mb-2 text-3xl font-bold text-gray-800">Success! 🎉</CardTitle>
            ...
            <CardContent className="space-y-4 px-8 pb-8">
              <Alert className="border-green-300 bg-gradient-to-r from-green-50 to-emerald-50 shadow-sm">
                <AlertDescription className="text-center text-sm text-green-900">
                  ...
                  <strong className="text-base">{userDetails.username}</strong>
                </AlertDescription>
              </Alert>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled
                  className="h-11 border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 text-gray-600"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-11 border-gray-300 pr-10 focus:border-teal-500 focus:ring-teal-500"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute top-1/2 right-3 -translate-y-1/2 text-gray-500 transition-colors hover:text-teal-600"
                  >
              ...
              <Button
                type="submit"
                className="h-12 w-full bg-gradient-to-r from-cyan-500 to-teal-500 text-base font-semibold text-white shadow-lg transition-all duration-200 hover:from-cyan-600 hover:to-teal-600"
