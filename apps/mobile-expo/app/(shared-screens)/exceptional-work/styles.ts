...
export const styles = StyleSheet.create({
  ...
  exceptionCard: { borderRadius: 12, padding: 14, marginBottom: 10, borderWidth: 1 },
...
export const modalStyles = StyleSheet.create({
  ...
  typeOptionSelectedWorking: { borderColor: '#0d9488', backgroundColor: '#f0fdfa' },
  typeOptionSelectedHoliday: { borderColor: '#dc2626', backgroundColor: '#fef2f2' },
  typeOptionText: { flex: 1, fontSize: 14, color: '#6b7280', fontWeight: '500' },
  ...
  weekdayCell: { width: CALENDAR_CELL_SIZE, alignItems: 'center', paddingVertical: 4 },
