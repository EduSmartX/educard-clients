...
interface HolidayFormModalProps {
  visible: boolean;
  isEditing: boolean;
  formData: { description: string; holiday_type: string; start_date: string; end_date: string };
  isSaving: boolean;
  onClose: () => void;
  onSubmit: () => void;
      ...
      >
        <View style={styles.formCard}>
          <View style={styles.formHeader}>
            <View>
              <Text style={styles.formTitle}>{isEditing ? 'Edit Holiday' : 'Add Holiday'}</Text>
              <Text style={styles.formSubtitle}>
                {isEditing ? 'Update holiday details' : 'Create a new holiday entry'}
              </Text>
            </View>
          ...
          <View style={styles.formActions}>
            ...
            >
              {isSaving ? (
                ...
                <Text style={styles.formSaveText}>{isEditing ? 'Update' : 'Create'}</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
