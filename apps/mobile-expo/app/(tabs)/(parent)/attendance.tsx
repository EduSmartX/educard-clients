  ...
  const renderContent = () => {
    ...
    return (
      <View className="px-4 pb-6 pt-4">
        ...
        >
          <Text className="text-4xl font-bold text-white">{summary.percentage.toFixed(1)}%</Text>
        ...
        <View className="mt-4 flex-row gap-3">
          ...
          <StatCard
            ...
            icon={XCircle}
          />
          <StatCard label="Late" value={summary.late} color={colors.warning[500]} icon={Clock} />
        </View>

        {/* Monthly Breakdown */}
        <Text className="mb-3 mt-6 text-sm font-semibold text-gray-600">📊 Monthly Breakdown</Text>
